...
export const ComparisonSection: React.FC = () => {
  ...
  return (
    <section id="why-different" className="py-24 bg-[#FAF9F5] border-b border-[#EAE6DF]">
            ...
            <div
              ...
              className={`relative rounded-2xl p-8 flex flex-col justify-between transition-all duration-300 ${
                card.isHighlighted
                  ...
                  : 'bg-white border border-[#E0DACF] shadow-sm hover:border-slate-300'
              }`}
            >
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className={`text-[11px] uppercase tracking-wider px-3 py-1 rounded-full border ${card.tagBg}`}>
                    {card.tag}
                  </span>
                </div>
              ...
              <div className="pt-8 mt-6 border-t border-slate-100">
                {card.isHighlighted ? (
                  <Link
                    to="/request-demo"
                    className="w-full py-3.5 px-4 rounded-xl bg-[#1C1A17] hover:bg-[#2C2925] text-white text-xs font-bold flex items-center justify-center gap-2 transition-all shadow-md"
                  >
                    <span>Get Started with Proposala</span>
                    <ArrowRight className="w-4 h-4 text-emerald-400" />
                  </Link>
                ) : (
                  <div className="w-full py-3 px-4 rounded-xl bg-slate-100 text-slate-500 text-xs font-medium text-center">
