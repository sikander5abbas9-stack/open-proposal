...
import { ClipboardPaste, CheckSquare, Layers, Edit3, Sparkles, ArrowRight, ShieldCheck, CheckCircle2 } from 'lucide-react';
...
export const HowItWorks: React.FC = () => {
  const steps = [
    {
      ...
      mockup: (
        <div className="bg-slate-900 rounded-2xl p-5 border border-slate-800 text-white space-y-3 shadow-xl">
          ...
          <div className="p-3 rounded-lg bg-slate-950 border border-slate-800 text-xs text-slate-300 space-y-1.5 font-mono">
            ...
            <div className="flex gap-2 text-[10px] pt-1">
              <span className="bg-emerald-950 text-emerald-400 border border-emerald-800 px-2 py-0.5 rounded">Budget: $2,500</span>
              <span className="bg-slate-800 text-slate-300 px-2 py-0.5 rounded">10-15 Proposals</span>
            </div>
          </div>
        </div>
      )
    },
    {
      ...
      mockup: (
        <div className="bg-white rounded-2xl p-5 border border-slate-200 text-slate-900 space-y-4 shadow-xl">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            ...
            <div className="text-right">
              ...
              <div className="text-[10px] font-bold text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded border border-emerald-200">HIGH FIT</div>
            </div>
          </div>
          <div className="space-y-2 text-xs">
            <div className="flex items-center justify-between p-2 rounded-lg bg-emerald-50 text-emerald-900 border border-emerald-200">
              <span className="flex items-center gap-1.5 font-semibold">
                <CheckCircle2 className="w-4 h-4 text-emerald-600" /> Payment Verified Client
              </span>
        ...
        <div className="bg-slate-900 rounded-2xl p-5 border border-slate-800 text-white space-y-3 shadow-xl">
          ...
          <div className="p-3.5 rounded-xl bg-slate-950 border border-emerald-500/30 space-y-2">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-emerald-500/20 text-emerald-300">Selected</span>
            </div>
    ...
    },
    {
      ...
      mockup: (
        <div className="bg-white rounded-2xl p-5 border border-slate-200 text-slate-900 space-y-3 shadow-xl">
          ...
          <div className="p-3 rounded-lg bg-slate-50 border border-slate-200 text-xs text-slate-700 space-y-2 leading-relaxed">
          ...
          <div className="flex justify-end pt-1">
            <span className="px-3 py-1 bg-[#1C1A17] text-white text-[11px] font-bold rounded-lg flex items-center gap-1">
              Copy Proposal <ArrowRight className="w-3 h-3 text-emerald-400" />
            </span>
          </div>
        </div>
      )
  ...
  return (
    <section id="how-it-works" className="py-24 bg-[#FAF9F5] border-b border-[#EAE6DF]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-20">
          ...
          <h2 className="text-3xl sm:text-5xl font-semibold text-[#1C1A17] tracking-tight font-serif leading-tight">
            ...
            return (
              ...
              >
                ...
                <div className={`lg:col-span-6 space-y-4 ${isEven ? 'lg:order-1' : 'lg:order-2'}`}>
                  ...
                  <h3 className="text-2xl sm:text-4xl font-semibold text-[#1C1A17] tracking-tight font-serif">
                    {s.title}
                  </h3>
                ...
                <div className={`lg:col-span-6 ${isEven ? 'lg:order-2' : 'lg:order-1'}`}>
                  <div className="relative group">
                    <div className="absolute -inset-1 bg-gradient-to-r from-emerald-500/10 to-teal-500/10 rounded-3xl blur-md group-hover:blur-lg transition-all" />
        ...
        <div className="mt-20 text-center">
          <Link
            to="/analyzer"
            className="px-8 py-4 rounded-xl bg-[#1C1A17] hover:bg-[#2C2925] text-white font-bold text-base shadow-lg shadow-slate-900/10 inline-flex items-center gap-2.5 transition-all transform hover:-translate-y-0.5"
          >
