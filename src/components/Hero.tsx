...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative overflow-hidden pt-12 pb-20 md:pt-20 md:pb-32 bg-slate-50 border-b border-slate-200">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <h1 className="text-4xl sm:text-6xl lg:text-7xl font-semibold text-slate-900 tracking-tight leading-[1.12] font-serif">
              Save your Connects.{' '}
            ...
            <div className="pt-3 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              <Link
                to="/request-demo"
                className="w-full sm:w-auto px-7 py-4 text-base font-bold text-white bg-slate-900 hover:bg-slate-800 rounded-sm shadow-lg shadow-slate-900/10 flex items-center justify-center transition-all transform hover:-translate-y-0.5 active:translate-y-0"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto px-6 py-4 text-base font-bold text-slate-800 bg-white hover:bg-slate-100 border border-slate-200 rounded-sm shadow-2xs flex items-center justify-center transition-all cursor-pointer"
              >
            ...
            <div className="pt-6 border-t border-slate-200 flex flex-wrap items-center justify-center lg:justify-start gap-6 text-sm font-semibold text-slate-700">
          ...
          {/* Right Column: Tech illustration with radar chart & data nodes */}
          <div className="lg:col-span-5 relative">
            ...
            >
              {/* Outer Glowing halo */}
              <div className="absolute -inset-2 bg-gradient-to-r from-emerald-500/20 via-teal-500/20 to-amber-500/20 rounded-full blur-xl" />

              {/* Main Card */}
              <div className="relative rounded-sm bg-white border border-slate-200 p-5 sm:p-6 shadow-2xl space-y-5">
                
                {/* Card Header */}
                <div className="flex items-center justify-between border-b border-slate-100 pb-4">
                  <div className="flex items-center gap-2.5">
                    <div className="w-8 h-8 rounded-sm bg-emerald-50 border border-emerald-200 flex items-center justify-center font-bold text-xs text-emerald-700 font-mono">
                      AI
                    </div>
                    <div>
                ...
                <div className="relative bg-slate-900 rounded-sm p-5 text-white overflow-hidden space-y-4 shadow-inner">
                  ...
                  <div className="relative z-10 h-44 flex items-center justify-center py-2">
                    ...
                    <div className="absolute top-2 right-2 bg-slate-800/90 backdrop-blur-md border border-emerald-500/40 px-2.5 py-1 rounded-sm text-[10px] text-emerald-300 shadow-md font-mono">
                      Verified Hire History
                    </div>
                  </div>

                  {/* Matched Case Study Node */}
                  <div className="relative z-10 bg-slate-800/80 rounded-sm p-2.5 border border-slate-700/80 flex items-center justify-between text-xs">
                ...
                <div className="flex items-center justify-between text-xs text-slate-600 bg-slate-50 p-3 rounded-sm border border-slate-200">
                  <span className="font-semibold text-slate-800">
                    Connect Saver Guard
                  </span>
                  <span className="text-emerald-700 font-bold bg-emerald-100/80 px-2 py-0.5 rounded-sm text-[11px]">
                    Recommended: BID
                  </span>
                </div>
