    ...
    <div className="min-h-screen bg-[#F8FAFC] text-[#0F172A] font-sans antialiased flex flex-col justify-between selection:bg-[#4F46E5] selection:text-white">
      ...
      <main className="flex-1 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          {/* Sub-Navigation Tabs */}
          <div className="bg-white p-2 sm:p-2.5 rounded-xl border border-[#E2E8F0] shadow-sm flex flex-wrap items-center justify-center sm:justify-start gap-2 text-xs font-semibold">
            <Link
              to="/terms"
          ...
          {/* Child Route Outlet */}
          <div className="bg-white p-6 sm:p-10 rounded-2xl border border-[#E2E8F0] shadow-sm">
            <Outlet />
          </div>
